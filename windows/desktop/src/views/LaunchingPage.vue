          ...
          setTimeout(() => {
            ...
            if(!OwAd){
              ...
              this.ad.addEventListener('impression', () => {
              	fetch(`${config.apiURL}/public/modpack/${this.instance?.id}/${this.instance?.versionId}/ad/play/video`);
              });
              this.ad.addEventListener('display_ad_loaded', () => {
                fetch(`${config.apiURL}/public/modpack/${this.instance?.id}/${this.instance?.versionId}/ad/play/static`);
              });
              //@ts-ignore
            }
          }, 500);
